  ...
  return (
    <Alert>
      ...
      <AlertDescription className="space-y-2 text-sm text-foreground/70">
        <p>
          Browser mode signs requests with your admin session. Switch to the Vault-signed mode if your organization requires pre-signed headers from Vault Transit. CI pipelines can continue using the CLI via
