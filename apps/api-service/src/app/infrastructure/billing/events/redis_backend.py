"""Redis implementation of the billing event backend."""
...
from app.services.billing.billing_events.protocols import (
    BillingEventBackend,
    BillingEventStream,
)


class RedisBillingEventStream(BillingEventStream):
    def __init__(
        self,
...
class RedisBillingEventBackend(BillingEventBackend):
    def __init__(
        self,
        redis: RedisBytesClient,
        *,
