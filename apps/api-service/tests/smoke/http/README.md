...
- Logs ingestion
- Optional: Billing plans + subscription lifecycle + portal/setup intent/payment methods + upcoming invoice preview + usage totals + usage/events (and stream with `SMOKE_ENABLE_BILLING_STREAM=1`)
