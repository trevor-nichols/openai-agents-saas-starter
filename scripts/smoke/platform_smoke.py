...
sys.path = [str(ROOT / "api-service"), str(ROOT), *_stdlib_paths, *_site_packages]

app_pkg_init = ROOT / "api-service" / "app" / "__init__.py"
...
main_spec = importlib.util.spec_from_file_location("app.main", ROOT / "api-service" / "main.py")
