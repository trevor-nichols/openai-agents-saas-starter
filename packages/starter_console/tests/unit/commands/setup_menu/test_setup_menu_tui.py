...
from starter_console.commands import setup as setup_command
from starter_console import ui as ui_module
...
def test_setup_menu_uses_textual(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setitem(sys.modules, "starter_console.ui", ui_module)
