"""Integration tests for the Stripe replay console helpers."""
...
from starter_console.workflows.stripe.dispatch import replay_dispatches_with_repo
...
@pytest.mark.asyncio
async def test_console_replay_completes_failed_dispatch(sqlite_repo, capsys):
