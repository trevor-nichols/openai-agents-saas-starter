...
from starter_console.workflows.home.probes.db import _pg_ping  # reuse db connectivity helper
...
def _db_revision(db_url: str) -> tuple[str | None, str | None]:
    ...
    try:
        from starter_console.workflows.home.probes.db import _normalize_db_url
