...
export const FEATURES_TESTIMONIAL: Testimonial = {
  quote: '“We replaced months of platform plumbing with Acme. GPT-5 routing, billing events, and ops dashboards landed together, so our team focused on the product.”',
  author: 'Priya Sharma',
