...
## Execution Plan
1. **Config & CLI surfaces** — Introduce the new env vars in `Settings`, Starter Console wizard, env templates, and trackers. Harden validation (TLS/auth) for non-demo profiles.
