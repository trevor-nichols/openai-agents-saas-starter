...
- `hatch run lint`
- `hatch run typecheck`
- `pytest anything-agents/tests/contract/test_agents_api.py`
- `pytest anything-agents/tests/integration/test_postgres_migrations.py::test_repository_roundtrip`
