...
- Starter CLI docs call out the need to capture real tenant UUIDs after seeding users so operators know how to satisfy the new requirement in CI and staging.

## Status

- [x] Runtime enforcement shipped (FastAPI + Postgres repository)
- [x] Developer tooling and docs updated (`starter_cli/README.md`)
