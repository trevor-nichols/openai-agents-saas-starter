...
- **Secrets**: Vault/Infisical/AWS Secrets Manager/Azure Key Vault via the Starter CLI.
...
- Use the Starter CLI to generate `.env.local` for local/dev, and to seed secrets providers for hosted environments.
