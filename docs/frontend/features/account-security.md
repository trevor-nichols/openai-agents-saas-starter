...
- Objective: provide a trustworthy surface for password maintenance, upcoming MFA, recent authentication activity, and operator-led password resets using the shared glass UI.
- Success signals:
