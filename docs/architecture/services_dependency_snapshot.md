...
- `app.services.users.user_service` ← 4 modules
- `app.services.auth_service` ← 4 modules
...
| `app.services.auth` | — |
| `app.services.auth.builders` | `app.services.auth`<br>`app.services.auth.service_account_service`<br>`app.services.auth.session_service`<br>`app.services.geoip_service`<br>`app.services.users.user_service` |
...
| `app.services.auth.session_service` | `app.services.auth.errors`<br>`app.services.auth.refresh_token_manager`<br>`app.services.auth.session_store`<br>`app.services.users.user_service` |
| `app.services.auth.session_store` | `app.services.geoip_service` |
| `app.services.auth_service` | `app.services.auth`<br>`app.services.auth.errors`<br>`app.services.geoip_service`<br>`app.services.users.user_service` |
...
| `app.services.signup.password_recovery_service` | `app.services.auth_service`<br>`app.services.users.user_service` |
...
| `app.services.tenant.tenant_settings_service` | — |
| `app.services.users` | — |
| `app.services.users.user_service` | `app.services.auth.builders`<br>`app.services.auth.session_service`<br>`app.services.auth_service`<br>`app.services.signup.password_recovery_service` |

> Generated by `scripts/moduleviz.py`.