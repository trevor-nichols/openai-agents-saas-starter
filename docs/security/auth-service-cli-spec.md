...
- Replay protection: CLI payloads include nonce/iat/exp; server enforces single-use via Redis-backed nonce cache (fakeredis-only in tests) with ≤5 minute TTL.
