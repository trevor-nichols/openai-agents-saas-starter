...
- **Structure:** every hero uses the pattern _eyebrow → title (≤12 words) → two-sentence description → primary/secondary CTAs_. Reference the constants under `web-app/features/marketing/*/constants.ts`.
