...
Append-only assistant message tokens.
...
### 9.5 `refusal.delta` / `refusal.done`
...
### 9.7 `tool.arguments.delta` / `tool.arguments.done`
...
### 9.8 `tool.code.delta` / `tool.code.done`
